        ...
        <div class="flex flex-col justify-center items-center bg-slate-100 max-w-7xl">
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0">
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase" ><a href="../user ourclubs/Rostrum.php">1. GeneticX</a> </h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/Srishti.php"> 2. Virtuosy – Musical Club</a></h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/edwins.php"> 3. AMS</a></h1>
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase  animate__animated animate__flipInY "><a href="../user ourclubs/algori.php"> 4. Nirmiti</a></h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase  animate__animated animate__flipInY "><a href="../user ourclubs/Apple.php">5. Technical Club</a> </h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/nss.php">6. Sports Club</a></h1>
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/ncc.php">7. Rangtarangini</a></h1>
