                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24"> Virtuosi – Musical Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">"Virtuosi" at IIITA Allahabad is a vibrant community of passionate musicians, dedicated to fostering creativity, collaboration, and musical excellence among its members. As one of the premier cultural clubs under the Student Activity Center (SAC), Virtuosi provides a platform for students with a love for music to come together, share their talents, and create memorable musical experiences.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Virtuosi'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Virtuosi'";
...
$sql   ="Select * from `members` where `club_name` = 'Virtuosi'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
