                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Sports Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">Welcome to the Sports Club of Indian Institute of Information Technology, Allahabad (IIITA)! At our club, we are dedicated to promoting physical fitness, sportsmanship, and a spirit of healthy competition among students. Whether you're a seasoned athlete or just looking to stay active, our club offers a range of activities and facilities to suit your interests.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Sports Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Sports Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Sports Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
