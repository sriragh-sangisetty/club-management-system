                        ...
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    ...
                                    <div class="m-1">Mon, Apr 13 2024 </div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">Effervescence - Cultural Fest</div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#"> "Effervescence" is not just a cultural fest; it's a celebration of creativity, talent, and diversity that ignites the spirit of IIITA (Indian Institute of Information Technology, Allahabad) and beyond. Year after year, Effervescence transforms the campus into a kaleidoscope of vibrant colors, electrifying performances, and unforgettable experiences.</a></div>
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">Effe, Apr 13</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    ...
                                    <div class="m-1">September 15, 2023 </div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">Prayaas</div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#">
                                "Prayaas" embodies the spirit of unity, support, and empowerment within the vibrant community of IIIT Allahabad. As the student welfare society, Prayaas is dedicated to fostering an inclusive and supportive environment where every student can thrive academically, socially, and emotionally.</a></div>
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">Prayaas Sep 15</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden w-full m-4 shadow-sm flex flex-col md:flex-row justify-center">
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    <!-- <div class="m-1 font-bold">Vlog,</div> -->
                                    <div class="m-1">Apr 08, 2023</div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">Gymkhana Elections</div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#">The Gymkhana Elections at IIITA Allahabad mark a pivotal moment in the campus's democratic fabric, where students come together to elect their representatives who will lead and advocate for their interests in various facets of campus life. As the apex student body, the Gymkhana embodies the spirit of student governance, responsibility, and collective action.
                                ...
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">April 08</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden w-full m-4 shadow-sm flex flex-col md:flex-row justify-center">
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    <!-- <div class="m-1 font-bold">Vlog,</div> -->
                                    <div class="m-1">March 15, 2024</div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">Asmita - Igniting the spirit of sports</div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#">"Asmita" is not just a sports fest; it's a celebration of athleticism, teamwork, and the indomitable spirit of sportsmanship. Hosted annually at IIIT Allahabad, Asmitha is a vibrant extravaganza that brings together students from across the campus and beyond to compete, showcase their talents, and revel in the thrill of sports. </a></div>
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">March 15</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="div animate__animated animate__fadeInUp">
        <form class="text-gray-600 body-font relative" action="" method="post">
            <div class="absolute inset-0 bg-gray-300">
              <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map" scrolling="no" src="https://www.google.co.in/maps/place/Indian+Institute+of+Information+Technology,+Allahabad/@25.4294481,81.7675723,17z/data=!3m1!4b1!4m6!3m5!1s0x399acda4892cc187:0xb07e2e87ab51e82a!8m2!3d25.4294481!4d81.7701526!16zL20vMDYyeXQ0?entry=ttu" style="filter: grayscale(3) contrast(1.2) opacity(0.4);"></iframe>
        ...
        <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <span class="ml-3 text-xl">IIITA</span>
            </a>
            <p class="mt-2 text-sm text-gray-500">IIIT Allahabad, Club management</p>
          </div>
          <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            <div class="lg:w-3/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <a class="text-gray-600 hover:text-gray-800">Indian Institute of Information Technology<br>
Jalwa, Prayagraj, <br>
211012, Allahabad 
Uttar Pradesh - INDIA.</a>
                ...
                <li>
                  <a class="text-gray-600 hover:text-gray-800">Email: principal08@gmail.com</a>
                </li>
              </nav>
            </div>
