                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">GeneticX CLUB</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-2/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">Geneticx – GeneticX is the pulsating heartbeat of dance enthusiasts at IIITA Allahabad. Established with a mission to nurture talent, promote creativity, and foster a vibrant dance culture, GeneticX is where rhythm meets expression, and passion finds its rhythm.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'GeneticX'";
...
?>
        ...
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'GeneticX'";
...
$sql   ="Select * from `members` where `club_name` = 'GeneticX'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
