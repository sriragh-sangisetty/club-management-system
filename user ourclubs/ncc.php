                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Rangtarangini</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">"Rangtarangini" is the vibrant drama club of the Indian Institute of Information Technology, Allahabad (IIITA). As a hub for creativity and expression, Rangtarangini provides a platform for students passionate about theater to showcase their talent, explore their artistic abilities, and immerse themselves in the world of drama.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Rangtarangini'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Rangtarangini'";
...
$sql   ="Select * from `members` where `club_name` = 'Rangtarangini'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
